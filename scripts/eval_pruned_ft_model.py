...
def parse_args():
    ...
    parser.add_argument("--sparsity", "-s", type=float, default=0.2, help="The target sparsity for the model. ")
    parser.add_argument(
        "--checkpoint",
        "-c",
        default="workdirs/ft",
        help="Path to the checkpoint file. If not specified, the latest checkpoint will be used.",
    )
    parser.add_argument(
        "--work-dir",
        "-w",
        default="workdirs/ft_eval",
...
def main():
    ...
    # skip the evaluation of the original model
